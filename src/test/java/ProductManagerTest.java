...
public class ProductManagerTest {
    ...
    public void setUp() {
        ...
        pm.addProduct("C1", "Coca-cola zero", 2.0);
        pm.addProduct("C2", "Coca-cola", 2.5);
        pm.addProduct("B1", "Lomo queso", 3.0);
        pm.addProduct("B1", "bacon queso", 3.5);
    }
    ...
    public void testProductByPrice() {
        ...
        Assert.assertEquals(2.0, products.get(0).getPrice(), 0);
        Assert.assertEquals(2.5, products.get(1).getPrice(), 0);
        Assert.assertEquals(3.0, products.get(2).getPrice(), 0);
    ...
    public void testAddOrder() {
        ...
        o.addLP(2, "Coca-cola");
        o.addLP(1, "Lomo queso");
        o.addLP(1, "bacon queso");
        pm.addOrder(o);
    ...
    public void testDeliverOrder() {
        ...
        Assert.assertEquals("381112838", o.getDNI());
    }

    // Funcion para ver cuantas ventas tiene un producto en especifico
    @Test
    public void testSales() {
        testDeliverOrder();

        Product p = pm.getProduct("C2");
        Assert.assertEquals(1, p.sales());
    }
